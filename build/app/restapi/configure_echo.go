...
//go:generate swagger generate server --target ../../app --name Echo --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/echo/build/templates --principal interface{}

func configureFlags(api *operations.EchoAPI) {
...
func configureAPI(api *operations.EchoAPI) http.Handler {
